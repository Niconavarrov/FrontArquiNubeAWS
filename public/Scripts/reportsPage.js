...
window.generateReport = async function() {
    try {
        ...
        const response = await fetchWithToken(
            `${ENDPOINTS.REPORTS}?startDate=${startDate}&endDate=${endDate}&format=${format}&type=${reportType}`
        );
...
window.downloadReport = async function(format) {
    try {
        ...
        const response = await fetchWithToken(
            `${ENDPOINTS.REPORTS}/download?startDate=${startDate}&endDate=${endDate}&format=${format}&type=${reportType}`
        );
...
window.getInventoryStatus = async function() {
    try {
        const response = await fetchWithToken(`${ENDPOINTS.REPORTS}/inventory-status`);
...
window.generateCustomReport = async function() {
    try {
        ...
        const response = await fetchWithToken(`${ENDPOINTS.REPORTS}/custom`, {
            method: 'POST',
